...
$sql = "SELECT harga FROM wisata Where Id_Wisata = 2";
...
<section class = "boxing">
    ...
    <form action="booking_system.php" method="post">
        <div class = "booking_data">
            ...
            <select type="text" name="tujuan"><option value = "Eiffel Tower">Eiffel Tower</option></select>
