...
$sql = "SELECT harga FROM wisata Where Id_Wisata = 5";
...
<section class = "boxing">
    ...
    <form action="booking_system.php" method="post">
        <div class = "booking_data">
            ...
            <select type="text" name="tujuan"><option value = "Piramida Mesir">Piramida Mesir</option></select>
    ...
    echo "Tidak ada data harga wisata.";
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/a_bKqM0_ZMo?si=Ghrg66HygFopDlZ0&amp;start=14" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
